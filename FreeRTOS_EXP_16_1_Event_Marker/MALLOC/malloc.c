...
__attribute__((aligned (32))) u8 mem2base[MEM2_MAX_SIZE] __attribute__((section("memory_b1_text")));     //�ⲿSRAM�ڴ��
__attribute__((aligned (32))) u8 mem3base[MEM3_MAX_SIZE] __attribute__((section(".ccmram")));	    //�ڲ�CCM�ڴ��
//�ڴ�����
u16 mem1mapbase[MEM1_ALLOC_TABLE_SIZE];													        //�ڲ�SRAM�ڴ��MAP
u16 mem2mapbase[MEM2_ALLOC_TABLE_SIZE] __attribute__((section("0X68000000+MEM2_MAX_SIZE")));	//�ⲿSRAM�ڴ��MAP
u16 mem3mapbase[MEM3_ALLOC_TABLE_SIZE] __attribute__((section("0X10000000+MEM3_MAX_SIZE")));	//�ڲ�CCM�ڴ��MAP
//�ڴ�������	   
